...
```{r ans51}
str_replace(twDates,"民國","") -> twDates1
str_replace(twDates1,"月","") -> twDates2
twDates2
# twDates2
```
...
```{r ans52}
twDates
str_sub(twDates,3,5) -> chineseyear
as.integer(chineseyear)+1911 -> westYears
westYears
# westYears
```
...
```{r ans53}
twDates2
str_split(twDates2,"年") -> dataSplit
map(dataSplit,~.[[2]]) ->monthList
